...
const Formats = [
  ...
  },
  {
    ...
    mod: "genxbrunica",
    ruleset: ["Standard NatDex", "OHKO Clause", "Evasion Clause", "Species Clause", "Terastal Clause", "Sleep Clause Mod", "Z-Move Clause", "Mega Data Mod", "Data Mod"],
    banlist: ["Akulut", "Wendora", "Lutakon", "Lutakon-Awakened"],
    //Ubers
    onValidateTeam(team, format) {
      let speciesTable = {};
    ...
    onValidateTeam(team, format) {
      ...
      for (const set of team) {
        ...
        if (template.tier !== "Mega" && template.tier !== "Paldea" && template.tier !== "Paldea (NFE)") {
          return [set.species + " is not a part of the Paldea Pok\xE9dex."];
        }
      }
    },
    onValidateSet(set) {
  ...
  */
  ...
  },
  {
    ...
    mod: "moderngen2birds",
    searchShow: false,
    ruleset: ["Standard", "Z-Move Clause", "!Obtainable Abilities"],
