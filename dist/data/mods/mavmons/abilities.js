...
const Abilities = {
  ...
  callofdarkness: {
    shortDesc: "At the end of each turn, if this Pok\xE9mon\u2019s HP is at half or lower, causes all opposing Pokemon to lose 1/8 of their maximum HP, rounded down.",
    onResidualOrder: 28,
  ...
  binarysoul: {
    onResidualOrder: 29,
    onResidual(pokemon) {
      if (pokemon.species.baseSpecies !== "Twinrova" || pokemon.terastallized)
        return;
