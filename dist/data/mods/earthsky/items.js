...
const Items = {
  ...
  hopoberry: {
    ...
    onUpdate(pokemon) {
      if (!pokemon.hp)
        return;
      if (pokemon.moveSlots.some((move2) => move2.pp === 0)) {
        pokemon.eatItem();
      }
    },
    onEat(pokemon) {
      const moveSlot = pokemon.moveSlots.find((move2) => move2.pp === 0) || pokemon.moveSlots.find((move2) => move2.pp < move2.maxpp);
      if (!moveSlot)
        return;
  ...
  adrenalineorb: {
    ...
    onDamagingHit(damage, target, source, move2) {
      ...
      if (["Dark", "Bug", "Ghost"].includes(move2.type) || move2.twoType && ["Dark", "Bug", "Ghost"].includes(move2.twoType)) {
        target.useItem();
      }
    },
  ...
  brightpowder: {
    ...
    onFoeTryMove(source, target, move2) {
      if (move2.target === "foeSide" || move2.target === "all" && move2.id !== "perishsong") {
        return;
      }
      if (move2.priority > 0.1 && target.useItem()) {
        this.add("activate", target, "item: BrightPowder");
        if (!this.dex.getImmunity("powder", source))
          return;
        this.attrLastMove("[still]");
        this.add("cant", source, "item: BrightPowder", move2, "[of] " + target);
        return false;
      }
    },
    num: 213,
  ...
  focusband: {
    ...
    onDamage(damage, target, source, effect) {
      ...
      console.log(monMove);
      if (monMove && (monMove.priority < 0 || monMove.fractionalPriority < 0) && monMove.category !== "Status" && damage >= target.hp && effect && effect.effectType === "Move") {
  ...
  oddincense: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Psychic" || move2.twoType && move2.twoType === "Psychic") {
        return this.chainModify([4505, 4096]);
      }
    },
    num: 314,
  ...
  reapercloth: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Ghost" || move2.twoType && move2.twoType === "Ghost") {
        return this.chainModify([4505, 4096]);
      }
    },
    rating: 2,
  ...
  rockincense: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Rock" || move2.twoType && move2.twoType === "Rock") {
        return this.chainModify([4505, 4096]);
      }
    },
    num: 315,
  ...
  roseincense: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Grass" || move2.twoType && move2.twoType === "Grass") {
        return this.chainModify([4505, 4096]);
      }
    },
    num: 318,
  ...
  sachet: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Fairy" || move2.twoType && move2.twoType === "Fairy") {
        return this.chainModify([4505, 4096]);
      }
    },
    rating: 2,
  ...
  seaincense: {
    ...
    onAllyBasePowerPriority: 15,
    onAllyBasePower(basePower, attacker, defender, move2) {
      if (move2.type === "Water" || move2.twoType && move2.twoType === "Water") {
        return this.chainModify([4505, 4096]);
      }
    },
    num: 254,
  ...
  shellbell: {
    ...
    onAfterMoveSecondarySelf(pokemon, target, move2) {
      if (move2.totalDamage && !pokemon.forceSwitchFlag) {
        this.heal(move2.totalDamage / 5, pokemon);
      }
    },
  ...
  silverpowder: {
    ...
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Bug" || move2.twoType && move2.twoType === "Bug")) {
  ...
  snowball: {
    ...
    consumable: true,
    onDamagingHit(damage, target, source, move2) {
      if (move2.type === "Ice" || move2.twoType && move2.twoType === "Ice") {
        target.useItem();
      }
    },
    boosts: {
  ...
  ultranecroziumz: {
    ...
    spritenum: 687,
    onTakeItem(item, source) {
      if (item.itemUser === source.baseSpecies)
        return false;
      return true;
    },
  ...
  buggem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Bug" || move2.twoType && move2.twoType === "Bug") && source.useItem()) {
  ...
  blackbelt: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Fighting" || move2.twoType && move2.twoType === "Fighting")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  blackglasses: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Dark" || move2.twoType && move2.twoType === "Dark")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  charcoal: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Fire" || move2.twoType && move2.twoType === "Fire")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  darkgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Dark" || move2.twoType && move2.twoType === "Dark") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  dracoplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Dragon" || move2.twoType && move2.twoType === "Dragon")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  dragongem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Dragon" || move2.twoType && move2.twoType === "Dragon") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  earthplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Ground" || move2.twoType && move2.twoType === "Ground")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  electricgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Electric" || move2.twoType && move2.twoType === "Electric") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  fairygem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Fairy" || move2.twoType && move2.twoType === "Fairy") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  fightinggem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Fighting" || move2.twoType && move2.twoType === "Fighting") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  firegem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Fire" || move2.twoType && move2.twoType === "Fire") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  flyinggem: {
    ...
    onSourceTryPrimaryHit(target, source, move2) {
      if (target === source || move2.category === "Status")
        return;
      if ((move2.type === "Flying" || move2.twoType && move2.twoType === "Flying") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
  ...
  ghostgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Ghost" || move2.twoType && move2.twoType === "Ghost") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  grassgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Grass" || move2.twoType && move2.twoType === "Grass") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  groundgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Ground" || move2.twoType && move2.twoType === "Ground") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  hardstone: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Rock" || move2.twoType && move2.twoType === "Rock")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  icegem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Ice" || move2.twoType && move2.twoType === "Ice") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  icicleplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Ice" || move2.twoType && move2.twoType === "Ice")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  ironplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Steel" || move2.twoType && move2.twoType === "Steel")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  magnet: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Electric" || move2.twoType && move2.twoType === "Electric")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  meadowplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Grass" || move2.twoType && move2.twoType === "Grass")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  mindplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Psychic" || move2.twoType && move2.twoType === "Psychic")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  mysticwater: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Water" || move2.twoType && move2.twoType === "Water")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  normalgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Normal" || move2.twoType && move2.twoType === "Normal") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  pixieplate: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Fairy" || move2.twoType && move2.twoType === "Fairy")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  poisonbarb: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Poison" || move2.twoType && move2.twoType === "Poison")) {
        return this.chainModify([4915, 4096]);
      }
    },
  ...
  poisongem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Poison" || move2.twoType && move2.twoType === "Poison") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  psychicgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Psychic" || move2.twoType && move2.twoType === "Psychic") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  rockgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Rock" || move2.twoType && move2.twoType === "Rock") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  sharpbeak: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Flying" || move2.twoType && move2.twoType === "Flying")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  silkscarf: {
    ...
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Normal" || move2.twoType && move2.twoType === "Normal")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  spelltag: {
    inherit: true,
    onBasePower(basePower, user, target, move2) {
      if (move2 && (move2.type === "Ghost" || move2.twoType && move2.twoType === "Ghost")) {
        return this.chainModify([4915, 4096]);
      }
    }
  },
  ...
  steelgem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Steel" || move2.twoType && move2.twoType === "Steel") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  watergem: {
    ...
    onPrepareHit(source, target, move2) {
      if (target === source || move2.category === "Status")
        return;
      if (move2 && (move2.type === "Water" || move2.twoType && move2.twoType === "Water") && source.useItem()) {
        source.addVolatile("gem");
      }
    },
    onSourceTryPrimaryHit(target, source, move2) {
  ...
  chilanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Normal" || move2.twoType && move2.twoType === "Normal") && (!target.volatiles["substitute"] || move2.flags["authentic"] || move2.infiltrates)) {
        if (target.eatItem()) {
  ...
  occaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Fire" || move2.twoType && move2.twoType === "Fire") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
          this.debug("-50% reduction");
  ...
  passhoberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Water" || move2.twoType && move2.twoType === "Water") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  wacanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Electric" || move2.twoType && move2.twoType === "Electric") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  rindoberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Grass" || move2.twoType && move2.twoType === "Grass") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  yacheberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Ice" || move2.twoType && move2.twoType === "Ice") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  chopleberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Fighting" || move2.twoType && move2.twoType === "Fighting") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  kebiaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Poison" || move2.twoType && move2.twoType === "Poison") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  shucaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Ground" || move2.twoType && move2.twoType === "Ground") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  cobaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Flying" || move2.twoType && move2.twoType === "Flying") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  payapaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Psychic" || move2.twoType && move2.twoType === "Psychic") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  tangaberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Bug" || move2.twoType && move2.twoType === "Bug") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  chartiberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Rock" || move2.twoType && move2.twoType === "Rock") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  kasibberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Ghost" || move2.twoType && move2.twoType === "Ghost") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  habanberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Dragon" || move2.twoType && move2.twoType === "Dragon") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  colburberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Dark" || move2.twoType && move2.twoType === "Dark") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  babiriberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Steel" || move2.twoType && move2.twoType === "Steel") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  roseliberry: {
    ...
    onSourceModifyDamage(damage, source, target, move2) {
      if ((move2.type === "Fairy" || move2.twoType && move2.twoType === "Fairy") && target.getMoveHitData(move2).typeMod > 0) {
        const hitSub = target.volatiles["substitute"] && !move2.flags["authentic"] && !move2.infiltrates;
        if (hitSub)
          return;
        if (target.eatItem()) {
  ...
  przcureberry: null,
  psncureberry: null,
  /* TRs are useless, but since they're coded and technically exist in Earth & Sky, might as well update them */
  /*tr00: {
  	inherit: true,
  	isNonstandard: null,
  },
