...
const Items = {
  ...
  redorb: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Groudon" || source.baseSpecies.baseSpecies === "Grousle")
        return false;
      return true;
    },
  ...
  blueorb: {
    ...
    onTakeItem(item, source) {
      if (source.baseSpecies.baseSpecies === "Kyogre" || source.baseSpecies.baseSpecies === "Kyottler")
        return false;
      return true;
    },
