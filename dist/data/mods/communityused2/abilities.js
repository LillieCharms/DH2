...
const Abilities = {
  generator: {
    ...
    condition: {
      ...
      onBasePower(basePower, attacker, defender, move) {
        if (this.effectState.generatorTriggers === 0)
          return this.chainModify([3, 4]);
        if (this.effectState.generatorTriggers === 1)
          return this.chainModify([4, 4]);
        if (this.effectState.generatorTriggers === 2)
          return this.chainModify([5, 4]);
        if (this.effectState.generatorTriggers === 3)
          return this.chainModify([6, 4]);
      }
    },
    flags: { breakable: 1 }
  },
  ...
  envious: {
    onBasePower(basePower, attacker, defender, move) {
      if (defender.hp === defender.baseMaxhp)
        return this.chainModify([13, 10]);
    },
    name: "Envious",
      ...
      onTryMove(pokemon, target, move) {
        ...
        if (this.effectState.lastMove === move.id) {
          ...
          if (move.name != "Devour") {
            ...
            this.debug(`Devour cancelled choke`);
        }
        this.effectState.lastMove = move.id;
      },
      onModifyDamage(damage, source, target, move) {
        if (this.effectState.hasChoked)
          return this.chainModify([3, 4]);
