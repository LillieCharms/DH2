...
const Scripts = {
  ...
  pokemon: {
    ignoringAbility() {
      ...
      return !!(this.battle.gen >= 5 && !this.isActive || (this.volatiles["gastroacid"] || this.volatiles["counteract"] || neutralizinggas && this.ability !== "neutralizinggas") && !this.getAbility().isPermanent);
    },
