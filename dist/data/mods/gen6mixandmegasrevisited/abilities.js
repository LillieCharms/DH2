...
const Abilities = {
  ...
  nostalgiatrip: {
    ...
    onModifyMove(move, pokemon) {
      if ((move.type === "Fire" || move.type === "Water" || move.type === "Grass" || move.type === "Electric" || move.type === "Dark" || move.type === "Psychic" || move.type === "Dragon" || move.type === "Fairy") && move.category === "Physical")
        move.category = "Special";
      if ((move.type === "Normal" || move.type === "Fighting" || move.type === "Flying" || move.type === "Ground" || move.type === "Rock" || move.type === "Bug" || move.type === "Ghost" || move.type === "Poison" || move.type === "Steel") && move.category === "Special")
