...
const Pokedex = {
  ...
  raticate: {
    inherit: true,
    evos: ["Plaguicate"]
    // Eviolite compatibility
  },
  plaguicate: {
    name: "Plaguicate",
    copyData: "Raticate",
    // inherits information from Raticate wherever it's missing data
    types: ["Normal", "Poison"],
  ...
  hoobarn: {
    ...
    // use generic flavor where not specified
    creator: "Bolivia"
  },
  heatmor: {
    inherit: true,
  ...
  tenoris: {
    name: "Tenoris",
    copyData: "Altaria",
    // evolves from Swablu but has more in common with Altaria
    types: ["Ice", "Dragon"],
  ...
  hocuspocus: {
    ...
    copyMoves: "Kadabra",
    // although its data is based on Alakazam, it doesn't have all of Alakazam's moves
  ...
  dolorak: {
    ...
    prevo: "Ariados",
    evoType: "levelExtra",
    evoCondition: "at night after poisoning 4 Pok\xE9mon in the same battle",
    creator: "BlueRay"
  },
  ledian: {
    inherit: true,
  ...
  alchemissus: {
    ...
    abilities: { 0: "Levitate", 1: "Corrosion", H: "Gluttony" },
    // this started as a typo but has been adopted as canon
  ...
  stokomotive: {
    name: "Stokomotive",
    copyData: "Coalossal",
    // evolves from Carkol but has more in common with Coalossal
  ...
  eclipseroid: {
    ...
    weightkg: 322,
    color: "Purple",
    prevo: ["Solrock", "Lunatone"],
    // no idea if this will work
    evoType: "other",
    evoCondition: "A mysterious Pok\xE9mon that can evolve from either Solrock or Lunatone...",
    creator: "ausma"
  },
  gourgeist: {
    inherit: true,
  ...
  jackourdsmall: {
    ...
    abilities: { 0: "Pickup", 1: "Harvest", H: "Hoard" },
    copyMoves: "Gourgeist",
    // it doesn't like copying from other Gourgeist forms
    movepoolAdditions: ["naturalgift", "weatherball"],
  ...
  dusglow: {
    name: "Dusglow",
    copyData: "Dusknoir",
    // evolves from Dusclops but has more in common with Dusknoir
    types: ["Ghost", "Fairy"],
  ...
  curski: {
    name: "Curski",
    copyData: "Spiritomb",
    // does not grant Eviolite access (compare Melmetal)
    types: ["Dark"],
  ...
  sundor: {
    ...
    copyData: "Scizor",
    copyMoves: "Scyther",
    // although its data is based on Scizor, it doesn't have all of Scizor's moves
    types: ["Bug", "Fighting"],
  ...
  scytherglacial: {
    ...
    abilities: { 0: "Swarm", 1: "Technician", H: "Wind Rider" },
    //Hopefully that just works.
  ...
  vibravawoodland: {
    ...
    movepoolAdditions: ["dazzlinggleam", "drainingkiss", "chargebeam"],
    //spirit break evo move
  ...
  froslasstheater: {
    ...
    movepoolDeletions: ["hex", "poltergeist", "willowisp"],
    //Snorunt gets hex but I'll note it here anyway
    prevo: "Snorunt",
    evoType: "useItem",
    evoItem: "Dusk Stone",
    creator: "ausma"
  },
  froslasstheaterunmasked: {
    //No stat changes, but I assume needs to exist for the Ability to work
  ...
  neuroboxin: {
    ...
    evoType: "levelMove",
    evoMove: "Reversal",
    //Doesnt feel THAT fitting, but 5 levels later than Grapploct/you gotta wait
    creator: "inkbug"
  },
  honedge: {
    inherit: true,
  ...
  doubladeverdant: {
    ...
    abilities: { 0: "Intrepid Sword", H: "Friend Guard" },
    movepoolAdditions: ["defog", "energyball", "gigadrain", "helpinghand", "leafblade", "tailwind", "whirlwind"],
    //Honedge has Helping Hand already from TM but it should be evolution move
    movepoolDeletions: ["toxic"],
  ...
  psiamat: {
    name: "Psiamat",
    copyData: "Meowstic",
    //Phione-like ""adjacent""; no evolutionary connection
    gender: "N",
    types: ["Psychic"],
    baseStats: { hp: 84, atk: 48, def: 86, spa: 93, spd: 91, spe: 91 },
    abilities: { 0: "Trace", 1: "Telepathy", H: "Technician" },
    movepoolAdditions: ["twinbeam", "extrasensory", "futuresight", "magicalleaf", "mefirst", "storedpower"],
    //new move + Meowstic-F's moves (cant be bothered)
    creator: "Paulluxx"
  },
  seviper: {
    inherit: true,
  ...
  mycecroak: {
    ...
    //If its mad about this im gonna be so sad
    creator: "BlueRay"
  },
  corsola: {
    inherit: true,
  ...
  psychosola: {
    name: "Psychosola",
    copyData: "Corsola",
    //Movepool based on Mirage Corsola, not Cursola
