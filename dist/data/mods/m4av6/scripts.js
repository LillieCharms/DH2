...
const Scripts = {
  ...
  init() {
    if (this.dataCache.Pokedex.raichumega)
      return;
    let megaList = [];
    for (const id in this.dataCache.Pokedex) {
      ...
      if (this.modData("FormatsData", id)) {
        ...
        else if (uber.includes(id))
          this.modData("FormatsData", id).tier = "Uber";
        else if (viabilityList.includes(id))
          this.modData("FormatsData", id).tier = "Popular";
        else if (megaViabilityList.includes(id))
