  ...
  megadatamod: {
    ...
    onBegin() {
      ...
      if (this.format.name === "[Gen 8] M4A Sandbox" || this.format.name === "[Gen 8] M4A VGC Sandbox") {
        ...
        this.add("-message", `Thanks to the work of KeroseneZanchu, you can even alter a Pok\xE9mon's type, stats and Mega form with its nickname!`);
        ...
        this.add("-message", `This is a National Dex-based format where we aim to give a new Mega Evolution to every Pok\xE9mon.`);
        this.add("-message", `Just like any official format, you can still only Mega Evolve one Pok\xE9mon per team!`);
