  ...
  actions: {
    ...
    runMove(moveOrMoveName, pokemon, targetLoc, sourceEffect, zMove, externalMove, maxMove, originalTarget) {
      ...
      if (zMove) {
        ...
        if (balmMoveData.type === pokemon.volatiles["typebalm"].balmType && balmMoveData.type === move.type && (move.category === balmMoveData.category || ![balmMoveData.category, move.category].includes("Status"))) {
